        ...
        .on("click", function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                     ...
                     localStorage.setItem("bookmarknumber", response.bookmarknumber);
                    updateBookmarkCount(response.total_items);
                ...
                success: function (data, textStatus, jqXHR) {
                   ...
                   // console.log(textStatus);
                    if(textStatus == "success")
                    {
                        ...
                        showMessage(data.status || "Deal added to cart!","success");
                    }else{
...
function updateCartUI(cartItems) {
    ...
    const imagePath = cartItems.product.product_media.length > 0
        ? cartItems.product.product_media.find(media => media.order === 1 && media.type === 'image')?.resize_path
        : 'assets/images/home/noImage.webp';
        
    $('.cart_items').append(`
        <div class="d-flex">
            <img src="${imagePath}" class="img-fluid dropdown_img" alt="${cartItems.product.name}" />
